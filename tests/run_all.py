...
LAYERS: List[Tuple[str, str, List[str]]] = [
    ...
    ("corpus", "what loaded, under what licence, and how source text is cleaned",
     ["test_source_permissions.py", "test_source_workflow.py", "test_framework_import.py", "test_asd_principles.py", "test_wa_pris.py", "test_textjoin.py", "test_packaging.py", "test_extracts.py"]),
    ...
    ("presentation", "layout arithmetic, the three renderers and the server",
     ["test_render.py", "test_navigation.py", "test_control_workspace.py", "test_extended.py", "test_audit_regressions.py", "test_security_boundaries.py"]),
