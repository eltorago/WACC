...
LAYERS: List[Tuple[str, str, List[str]]] = [
    ...
    ("corpus", "what loaded, under what licence, and how source text is cleaned",
     ["test_source_permissions.py", "test_source_workflow.py", "test_framework_import.py", "test_asd_principles.py", "test_textjoin.py", "test_packaging.py", "test_extracts.py"]),
