...
NAMED_SETS: Dict[str, Tuple[str, Optional[str], str]] = {
    ...
    "pris": ("wa-pris", None, "the WA PRIS Act"),
    "wa pris": ("wa-pris", None, "the WA PRIS Act"),
    "pris act": ("wa-pris", None, "the WA PRIS Act"),
    "wa pris act": ("wa-pris", None, "the WA PRIS Act"),
    "privacy and responsible information sharing act": ("wa-pris", None, "the WA PRIS Act"),
    "privacy and responsible information sharing act 2024": ("wa-pris", None, "the WA PRIS Act"),
